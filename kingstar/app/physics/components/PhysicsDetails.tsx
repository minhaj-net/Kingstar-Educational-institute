...
const physicsMajors = [
  { name: "Matchmetics", image: "/slide-1.jpg" },
  { name: "Lab Technician", image: "/slide-4.jpg" },
  { name: "Nanotechnologist", image: "/slide-2.jpg" }
];
...
export default function PhysicsDetails() {
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            {/* Specialized List Interactivity */}
            ...
            >
              ...
              <div className="space-y-8 relative z-10">
                ...
                <div className="pt-8 border-t border-white/10">
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Social Presence</p>
              ...
              {/* Decorative Brand Background Marker */}
