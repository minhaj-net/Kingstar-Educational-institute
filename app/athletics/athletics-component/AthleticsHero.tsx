...
export default function AthleticsHero() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const onScroll = () => {
        ...
        gsap.set(bgRef.current, { y: (-rect.top / (rect.height || 1)) * 28 });
      };
  ...
  return (
    ...
    >
      {/* ── Background: ImgBB basketball court image ── */}
      <div
        ref={bgRef}
      ...
      >
        <Image
          src="https://i.ibb.co.com/GvBvqsy6/8bcffe42a5f4ae3a02f7132a3fc9a6b6.jpg"
          alt="Kingster University Athletics – basketball court aerial view"
          fill
      ...
      {/* ── Very light overlay — image stays vivid ── */}
