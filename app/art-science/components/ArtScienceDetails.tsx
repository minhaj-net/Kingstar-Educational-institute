...
const artMajors = [
  { name: "Anthropology", image: "/slide-1.jpg" },
  { name: "Art History & Classics", image: "/slide-4.jpg" },
  { name: "Cinema Studies", image: "/slide-2.jpg" }
];
...
export default function ArtScienceDetails() {
  useEffect(() => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                {artMajors.map((major) => (
                  <div 
                    key={major.name} 
                    className="relative h-44 group overflow-hidden rounded-sm cursor-pointer border border-gray-100"
                  >
                    <img 
                      src={major.image} 
                      alt={major.name}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-5" data-aos="fade-up">
              {highlights.map((item) => (
                <div key={item} className="flex items-center gap-4 text-gray-700 hover:text-[#4caf50] transition-colors cursor-default">
                  <div className="w-6 h-6 rounded-full border-2 border-[#4caf50] flex items-center justify-center">
              ...
              <div className="space-y-8">
                ...
                <div className="pt-8 border-t border-white/10">
                  ...
                  <div className="flex gap-6">
                    {[1, 2, 3, 4].map((i) => (
                      <button key={i} className="text-white/60 hover:text-[#4caf50] transition-colors"><Globe size={20} /></button>
                    ))}
                  </div>
                </div>
